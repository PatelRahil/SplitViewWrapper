...
struct SplitViewWrapperView<DataSource: SplitViewDataSource, ListItemType: SplitViewListItemProtocol, DetailViewType: SplitViewDetailProtocol, HeaderViewType: SplitViewHeaderProtocol> : View {
    ...
    var body: some View {
        return SplitView(master: MasterSplitView<DataSource, ListItemType, DetailViewType, HeaderViewType>(), detail: DetailSplitView<DataSource.DataType, ListItemType, DetailViewType, HeaderViewType>())
            .onAppear {
